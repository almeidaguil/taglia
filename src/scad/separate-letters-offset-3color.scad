// Separate Letters - 3 Colors
// Generate one letter at a time with 3 color layers
// Tip: render once per letter of your word
...
module base_part() {
  difference() {
    // Letter silhouette as base with padding
