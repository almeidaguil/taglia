...
export const imageTo3dOffset: ModelDefinition = {
  ...
  description:
    'Transforma qualquer silhueta em um relevo 3D em camadas escalonadas. Cada camada pode ser impressa em uma cor diferente trocando o filamento — cria um efeito visual de profundidade e bordas.',
  category: 'tools',
  difficulty: 'easy',
  tags: [
    'imagem',
